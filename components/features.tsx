...
export function Byline(props: {
  ...
  return (
    <div className={`flex w-full items-center gap-2 ${props.className}`} data-tina-field={props.fieldName}>
        ...
        <div className="mx-auto max-w-2xl lg:text-left">
          ...
          <div data-tina-field={tinaField(props, 'message')}>
            <TinaMarkdown content={props.message} components={{
              h2: props => <h2 className="mt-2 text-3xl font-bold tracking-tight text-primary sm:text-4xl" {...props} />,
              p: props => <p className="mt-8 text-lg leading-8 text-primary" {...props} />
            }} />
          </div>
        </div>
